...
class TaskUpdateRequestTest extends PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        $this->request = new \App\Http\Requests\TaskUpdateRequest();
    }
    ...
    /** @test */
    public function the_validation_on_the_name_of_the_task_should_be_performed_sometimes()
    {
        $this->assertContains('sometimes', $this->request->rules()['name']);
